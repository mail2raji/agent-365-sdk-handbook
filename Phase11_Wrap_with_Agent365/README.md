...
Create [`requirements.txt`](code/my-first-a365-agent/requirements.txt) with these lines (we provide it in this lab's `code/` folder — copy/paste):
...
Create [`app.py`](code/my-first-a365-agent/app.py):
...
Copy [`.env.example`](code/my-first-a365-agent/.env.example) to `.env`:
...
If you don't have icons yet, use placeholders. The lab includes free ones in [`code/my-first-a365-agent/manifest/`](code/my-first-a365-agent/manifest/).
...
Open `app.py` and **add three things** (full reference: [`code/my-first-a365-agent/app.py`](code/my-first-a365-agent/app.py) after observability):
