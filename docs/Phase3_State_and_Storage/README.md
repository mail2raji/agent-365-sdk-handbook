...
[`code/shopping_cart_agent/app.py`](https://github.com/mail2raji/agent-365-sdk-handbook/blob/main/Phase3_State_and_Storage/code/shopping_cart_agent/app.py)
...
# Wire it up:
AGENT_APP = AgentApplication[CartState](https://github.com/mail2raji/agent-365-sdk-handbook/blob/main/Phase3_State_and_Storage/storage=MemoryStorage(), state_class=CartState)
```
