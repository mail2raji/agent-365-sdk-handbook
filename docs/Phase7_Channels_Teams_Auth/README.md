...
A copy lives at [`code/profile_agent/teams_manifest/manifest.json`](https://github.com/mail2raji/agent-365-sdk-handbook/blob/main/Phase7_Channels_Teams_Auth/code/profile_agent/teams_manifest/manifest.json). Zip the three files and upload via Teams → **Apps → Manage your apps → Upload an app**.
...
[`code/profile_agent/app.py`](https://github.com/mail2raji/agent-365-sdk-handbook/blob/main/Phase7_Channels_Teams_Auth/code/profile_agent/app.py) puts it together:
