...
async def test_get_weather_tool_dispatches():
    ...
    result = tools_v3.DISPATCH["get_weather"](https://github.com/mail2raji/agent-365-sdk-handbook/blob/main/Phase9_Testing_and_Deployment/city="Tokyo")
...
async def test_lookup_policy_returns_string_when_no_index():
    ...
    rag._chunks = []
    rag._vectors = None
    result = tools_v3.DISPATCH["lookup_policy"](https://github.com/mail2raji/agent-365-sdk-handbook/blob/main/Phase9_Testing_and_Deployment/question="anything")
