...
You don't have to write `start_server` from scratch — but for transparency we provide a 20-line version in [code/echo_agent/start_server.py](https://github.com/mail2raji/agent-365-sdk-handbook/blob/main/Phase1_Foundations/code/echo_agent/start_server.py).
